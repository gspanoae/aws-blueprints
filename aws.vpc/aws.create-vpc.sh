...
SUBNET_PUBLIC_2a_TAG_NAME=sysVpc-net-public2a
SUBNET_PRIVATE_2a_CIDR=10.1.11.0/24
SUBNET_PRIVATE_2a_TAG_NAME=sysVpc-net-private2a

SUBNET_PUBLIC_2b_CIDR=10.1.20.0/24
SUBNET_PUBLIC_2b_TAG_NAME=sysVpc-net-public2b
SUBNET_PRIVATE_2b_CIDR=10.1.21.0/24
SUBNET_PRIVATE_2b_TAG_NAME=sysVpc-net-private2b
# ###########################################################
# Set Route Table tags
ROUTE_TABLE_PUBLIC_TAG_NAME=sysRtb-public
ROUTE_TABLE_PRIVATE_TAG_NAME=sysRtb-private
# ###########################################################
